        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <form className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-md mx-auto">
              ...
              />
              <button type="submit" className="w-full sm:w-auto px-6 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 flex items-center justify-center">
                Get Started
      ...
      <section className="w-full py-12 md:py-24 bg-gray-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/find-work" className="px-8 py-3 bg-white text-gray-600 rounded-md hover:bg-gray-100">
              Find Work
            </Link>
            <Link href="/post-job" className="px-8 py-3 bg-gray-700 text-white rounded-md hover:bg-gray-800">
              Post a Job
            </Link>
          </div>
        </div>
